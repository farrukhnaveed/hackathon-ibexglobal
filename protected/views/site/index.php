...
<aside id="fh5co-hero">
	<div class="flexslider">
		<ul class="slides">
	   	<li style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/img_bg_1.jpg')">
		   			...
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 slider-text">
		   				<div class="slider-text-inner">
		   					<h1>Not Every Project Needs To Be Perfect</h1>
								<h2>Free html5 templates Available at <a href="#" target="_blank">Turtle Team</a></h2>
	   	...
	   	<li style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/img_bg_2.jpg')">
	   		<div class="overlay-gradient"></div>
	   		<div class="container-fluid">
	   			<div class="row">
		   			<div class="col-md-6 col-md-offset-3 col-md-push-3 slider-text">
		   				<div class="slider-text-inner">
		   					<h1>WordPress Theme For People Who Tell Stories</h1>
								<h2>Free html5 templates Available at <a href="#">Turtle Team</a></h2>
								<p><a class="btn btn-primary btn-demo" href="#"></i> View Demo</a> <a class="btn btn-primary btn-learn">Learn More</a></p>
		   				</div>
		   			</div>
		   		</div>
	   	...
	   	<li style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/img_bg_4.jpg')">
	   		<div class="overlay-gradient"></div>
	   		<div class="container-fluid">
	   			<div class="row">
		   			<div class="col-md-6 col-md-offset-3 col-md-push-3 slider-text">
...
<div id="fh5co-work" class="fh5co-light-grey">
	...
	<div class="row">
		<div class="col-md-4 text-center animate-box">
			<a href="#" class="work"  style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/portfolio-1.jpg')">
				<div class="desc">
					<h3>Project Name</h3>
		...
		<div class="col-md-4 text-center animate-box">
			<a href="#" class="work" style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/portfolio-2.jpg')">
				<div class="desc">
					<h3>Project Name</h3>
					<span>Brading</span>
				</div>
		...
		<div class="col-md-4 text-center animate-box">
			<a href="#" class="work" style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/portfolio-3.jpg')">
				<div class="desc">
					<h3>Project Name</h3>
					<span>Illustration</span>
				</div>
...
<div id="fh5co-blog" class="blog-flex">
	<div class="featured-blog" style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/blog-1.jpg')">
		<div class="desc-t">
			<div class="desc-tc">
		...
		<div class="row">
			<div class="col-md-12 animate-box">
				<a href="#" class="blog-post">
					<span class="img" style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/blog-2.jpg')"></span>
					<div class="desc">
			...
			<div class="col-md-12 animate-box">
				<a href="#" class="blog-post">
					<span class="img" style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/blog-1.jpg')"></span>
					<div class="desc">
			...
			<div class="col-md-12 animate-box">
				<a href="#" class="blog-post">
					<span class="img" style="background-image: url('<?php echo Yii::app()->request->baseUrl?>/static/images/blog-3.jpg')"></span>
					<div class="desc">
						<h3>16 Outstanding Photography WordPress Themes You Must See</h3>
						<span class="cat">Collection</span>
					</div>
